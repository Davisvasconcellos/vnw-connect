  ...
  return (
    <>
      <header className={s.header}>
        ...
        <img className={s.imgUser} src="https://lh3.googleusercontent.com/ogw/AF2bZyhb6d75IX4bZt427JYRAbLVRVnTesOp_AOGJpiB_Tee0VY=s32-c-mo" alt="Imagem do usuário" onClick={() => setMenuAberto(!menuAberto)}/>
      </header>
      <nav className={menuAberto ? s.navUser : s.closedNavUser}>
        <Link to={"/usuario"} onClick={() => setMenuAberto(false)}>Davis Vasconcellos</Link>
